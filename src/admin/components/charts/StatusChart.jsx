            ...
            <div className="flex-col items-center">
              <div className="flex items-center mb-1">
                ...
                <div
                  ...
                  id="chart-info"
                  role="tooltip"
                  className="absolute z-10 invisible inline-block text-sm text-white transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 w-72 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400">
                  <div className="p-3 space-y-2">
                    <h3 className="font-semibold text-gray-900 dark:text-white">
                      Customer Satisfaction
                    </h3>
                    <p className="text-gray-500 ">
                      This chart shows the percentage of customers who are
                      satisfied with our services. A higher percentage indicates
                    ...
                    <p className="text-gray-500 ">
                      The satisfaction percentage is calculated based on
                      customer feedback and survey results. It represents the
                      proportion of customers who rated their experience as
              ...
              <div
                ...
                className="z-50 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-80 lg:w-96 dark:bg-gray-700 dark:divide-gray-600">
                <div className="p-3" aria-labelledby="dateRangeButton">
                  <div
                    ...
                    <span className="mx-2 text-white dark:text-gray-400">
                      to
                    </span>
                    <div className="relative">
                      <div className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
          ...
          <div className="grid grid-cols-1 items-center border-gray-200 border-t dark:border-gray-700 justify-between">
            <div className="flex justify-between items-center pt-5">
              ...
              <button
                ...
                data-dropdown-toggle="lastDaysdropdownCss"
                data-dropdown-placement="bottom"
                className="text-sm font-medium text-gray-500 text-gray-500  dark:text-gray-400 hover:text-gray-900 text-center inline-flex items-center dark:hover:text-white"
                type="button">
                Last 7 days
                <svg
