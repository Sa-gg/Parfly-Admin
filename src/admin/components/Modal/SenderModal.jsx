...
const SenderModal = ({
  ...
  const filteredData = senderData.filter(
    (client) =>
  ...
  const handleSelect = (client) => {
    const selected = { id: client.user_id, name: client.full_name };
    if (type === "sender" && onSelectSender) {
      onSelectSender(selected);
    } else if (type === "receiver" && onSelectReceiver) {
      onSelectReceiver(selected);
    }
