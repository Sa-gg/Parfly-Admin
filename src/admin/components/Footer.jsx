const Footer = () => {
  return (
    <>
      <footer className=" p-4 my-6 mt-8 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 xl:p-8 dark:bg-gray-800">
