          ...
          <div className="sm:flex flex">
            ...
            <div className="flex items-center ml-auto space-x-2 sm:space-x-3 w-full md:w-auto md:justify-end justify-normal">
              <button
                ...
                className="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary hover:bg-[#e67300]  focus:ring-4 focus:ring-[#fc7f0281] sm:w-auto dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                <svg
                    ...
                    <th scope="col" className="p-4">
                      <div className="flex items-center">
                        <input
                          ...
                          type="checkbox"
                          className="w-4 h-4 border-gray-300 rounde bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600"
                        />
                      ...
                      <tr
                        ...
                        <td className="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                          <img
                            ...
                            src="/admin/src/assets/img/people/team-4.jpg"
                            alt=" avatar"
                          />
                        ...
                        <td className="p-4 space-x-2 whitespace-nowrap">
                          ...
                          <button
                            type="button"
                            onClick={() => handeleDelete(client.user_id)}
